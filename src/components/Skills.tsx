...
export default function (skillsData: SkillsData) {
    ...
    return <section className="relative flex flex-col items-center border-y-2 border-cyan-900 w-full shadow-md shadow-cyan-900  before:absolute before:-z-10 before:bg-center before:bg-cover before:bg-no-repeat before:opacity-60 before:bg-[url('src/assets/svg/stacked-peaks-16:9.svg')] before:content-[''] before:w-full before:h-full">
