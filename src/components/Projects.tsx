...
export default function Projects(projectData: ProjectsData) {
    function distribute(entries: Array<ProjectData>, total: number): ReactNode {
        ...
        const getHistory = (project: ProjectData, index: number) => {
            return <li className="list-disc list-inside w-1/2 p-6 border-cyan-900 first:border-y-2 last:border-x-2 odd:border-r-2 even:border-y-2 shadow-md shadow-cyan-900">
    ...
    return <section className="relative flex flex-col layered-waves items-center border-b-2 border-cyan-900 shadow-md shadow-cyan-900  before:absolute before:-z-10 before:bg-center before:bg-cover before:bg-no-repeat before:opacity-30 before:content-[''] before:w-full before:h-full ">
