...
export default function Education(educationData: EducationData) {
    return <section className="relative flex flex-col stacked-waves items-center w-full border-b-2 border-x-2 border-cyan-900 shadow-md shadow-cyan-900 before:absolute before:-z-10 before:bg-center before:bg-cover before:bg-no-repeat before:opacity-60 before:content-[''] before:w-full before:h-full">
